    ...
    <section id='skills' className='kage-sec'>
      ...
      <div className='mb-12 max-w-xl'>
        <h2 className='kage-display text-[clamp(28px,3.8vw,52px)] text-[var(--bone)] mb-3'>
          {skills.headline || 'Technical Disciplines'}
        </h2>
        <p className='kage-body text-[#9aa5a0]'>
          A focused toolkit honed across 5+ years of shipping enterprise web
          applications, creative micro-interactions, and high-performance
          systems.
        </p>
      </div>
