...
export async function HeroSection() {
  ...
  return (
    <section className="min-h-screen flex flex-col justify-between pt-20 md:pt-24 pb-10 px-6 relative overflow-hidden bg-gradient-to-b from-background via-background to-background/95">
      {/* Parallax Background Elements */}
      <HeroBackground />

      {/* Main Content */}
      <div className="flex-1 flex flex-col justify-center max-w-7xl w-full mx-auto relative z-10 px-4 md:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-[minmax(0,3fr)_minmax(0,2fr)] gap-6 md:gap-8 items-start overflow-visible">
            ...
            <div className="mt-4 md:mt-8 flex flex-col items-start md:items-end gap-6">
              ...
              <div className="flex items-center gap-4">
                <Button
                  variant="ghost"
                  asChild
                  className="hover:bg-primary/10 p-2 h-auto"
                >
                  <a
