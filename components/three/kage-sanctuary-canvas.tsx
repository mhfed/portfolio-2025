...
export function KageSanctuaryCanvas() {
  ...
  useEffect(() => {
    ...
    // =========================================================================
    const ambientLight = new THREE.AmbientLight(0x0a1218, 1.6)
    ...
    // Warm stone lantern lights (flickering candle flame inside)
